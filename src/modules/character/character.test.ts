...
const getAllCharacterIdsMock = getAllCharacterIds as jest.MockedFunction<typeof getAllCharacterIds>
const getCharacterMock = getCharacter as jest.MockedFunction<typeof getCharacter>
...
describe('getCharacterbyId', () => {
  it('should return cache when exist', async () => {
    ...
    await getCharacterById({params: {characterId: 1011334}}, {send: mockResponseSend});
  ...
  it('should call api to get character ids when cache doesn\'t exist', async () => {
    ...
    await getCharacterById({params: {characterId: 1234567}}, {send: mockResponseSend});
    expect(mockResponseSend).toBeCalledWith(expectedCharacter);
